...
with tab1:
   ...
   df = pd.read_csv(r'E:/studyyy/year4/senior pj/test/web_test/event2022_withd.csv',encoding='ISO-8859-1')
...
with tab2:
   ...
   accgdf_2021 = gpd.read_file('E:/studyyy/year4/senior pj/test/web_test/count_2022.shp')
   ...
   acc_no2021 = process_data("E:/studyyy/year4/senior pj/test/web_test/count_acc_d2022.csv")
...
with tab3:
 ...
 ##########local
   ...
   # อ่านไฟล์ HTML
   with open("E:/studyyy/year4/senior pj/test/web_test/local_moran_map2022.html", "r") as file:
       html_code = file.read()
